...
Date Planner — веб-сервис для создания персональных приглашений на свидание и последующего совместного планирования. На первом этапе проект предоставляет адаптивную интерактивную страницу приглашения, небольшой health API и основу monorepo с запуском через Docker.
...
Следующий небольшой этап — добавить модель приглашения и версионированный API создания и чтения с валидацией и тестами. Затем можно реализовать публичные ссылки, сохранение ответа, совместный выбор даты, времени и места, а также итоговую страницу автора. Авторизацию, фоновые очереди и deployment-инфраструктуру стоит добавлять только по мере появления конкретной продуктовой необходимости.
