...
Date Planner — веб-сервис для создания персональных приглашений на свидание и последующего совместного планирования. Сейчас проект предоставляет форму создания приглашения, персональную интерактивную страницу для получателя, защищённую ссылку автора и согласование одного из двух–пяти вариантов даты, времени и места.
...
Поле `message` необязательно: его можно не передавать или отправить пустой строкой. Имена автора и получателя остаются обязательными.
...
Следующий небольшой этап — скачать подтверждённый план как календарный файл `.ics` с корректным часовым поясом. После него можно добавить добровольные напоминания и отдельно продумать контролируемый возврат к согласованию без случайной потери финального плана.
