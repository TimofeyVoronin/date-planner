    ...
    <section class="manage-shell" aria-labelledby="manage-page-title">
      ...
      <template v-else-if="invitation">
        ...
        <article class="manage-card">
          ...
          <section
            v-if="invitation.creation_mode === 'extended'
              && invitation.publication_status === 'draft'"
            class="builder-entry"
            aria-labelledby="builder-entry-title"
          >
            <span class="builder-entry__icon" aria-hidden="true">✨</span>
            <div>
              <p>Расширенный режим</p>
              <h2 id="builder-entry-title">Продолжи настройку в конструкторе</h2>
              <span>Пройди четыре шага и подготовь приглашение перед публикацией.</span>
            </div>
            <NuxtLink :to="builderPath">Открыть конструктор</NuxtLink>
          </section>
