...
<template>
  <section class="builder-screen-editor" aria-labelledby="builder-acceptance-editor-title">
    ...
    <div class="builder-screen-editor__layout">
      ...
      <aside class="builder-screen-editor__preview" aria-labelledby="builder-acceptance-preview-title">
        <div class="builder-screen-editor__preview-heading">
          <p>Живой предпросмотр</p>
          <h4 id="builder-acceptance-preview-title">Так выглядит экран после согласия</h4>
        </div>
        <div class="builder-phone-preview">
          <div class="builder-phone-preview__speaker" aria-hidden="true" />
          <InvitationPreviewCard
            :acceptance-screen="previewScreen"
            :allow-reset="false"
